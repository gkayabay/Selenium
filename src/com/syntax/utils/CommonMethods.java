...
public class CommonMethods extends BaseClass { // we need the object of webDriver so we extends from BaseClass
...
//switch to frame by index
	...
	public static void selectCalendarDate(List<WebElement> element, String text) {
		...
		for(WebElement pickDate: element) {
			if(pickDate.isEnabled()) {   //make sure the element is Enabled().
