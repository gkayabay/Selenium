...
public class TableDemo {   //This table is for static table
	...
	public static void main(String[] args) {
		...
		List<WebElement> rows = driver.findElements(By.xpath("//table[@id='task-table']/tbody/tr"));//whole table 
		...
		List<WebElement> cols = driver.findElements(By.xpath("//table[@id='task-table']/thead/tr/th")); //whole cols
