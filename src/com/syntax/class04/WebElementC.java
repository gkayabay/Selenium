package com.syntax.class04;
		...
		public class WebElementC {
			...
			public static void main(String[] args) throws InterruptedException {
				...
				loginBtn.click();//summit-->will wait for the next page to load, but clik()-->does not wait for the page to load
				...
				//Login e tiklayinca uyari mesaji veren text "invalid credentials"
