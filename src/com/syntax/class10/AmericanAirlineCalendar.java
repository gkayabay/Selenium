...
public class AmericanAirlineCalendar {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Enter from and To Airports (gidis donus havalani)
		//click on the calender and select month and year
		//giids boxini inspect etti 
		//String dMonth--> we inspect both month and year as a title together (like MAy 2020)
